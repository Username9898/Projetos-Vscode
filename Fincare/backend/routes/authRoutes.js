...
// Mock de usuário para demonstração (em produção, usar banco de dados)
const users = [];
...
router.post('/register', async (req, res) => {
  ...
  try {
    ...
    res.status(201).json({ message: 'Usuário criado com sucesso!', token, user: { id: user.id, name, email } });
  } catch (error) {
